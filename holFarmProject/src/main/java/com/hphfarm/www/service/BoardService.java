...
////////////////////////////////////////////////////////////	
	...
	// 메인페이지 미니 게시판(공지사항)
	List<BoardDto> mainMiniNoitice();
	// 메인페이지 미니 게시판(정보게시판)
	List<BoardDto> mainMiniInfo();
	// 메인페이지 미니 게시판(거래게시판)
	List<BoardDto> mainMiniTrade();
	// 메인페이지 미니 게시판(자유게시판)
	List<BoardDto> mainMiniFree();
	// 메인페이지 미니 게시판(유저게시판)
	List<BoardDto> mainMiniUser();
	// 메인페이지 미니 게시판(농장주게시판)
	List<BoardDto> mainMiniFarmer();
