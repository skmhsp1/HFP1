...
///////////////////////공지사항 ////////////////
	...
	public Map<String, Object> list(NumberDto numberDto) {
		...
		List<BoardDto> list = boardMapper.selectNoticeBoardList(nDto.getStartrow(), nDto.getEndrow(),
				nDto.getCategory(), nDto.getSearchword(), nDto.getBc_no());
		map.put("list", list);
		map.put("nDto", nDto);
		return map;
	}
	...
	public Map<String, Object> boardUserlist(NumberDto numberDto) {
		...
		List<BoardTotalDto> list = boardTotalMapper.SelectUserBoardList(nDto.getStartrow(), nDto.getEndrow(),
				nDto.getCategory(), nDto.getSearchword(), nDto.getBc_no());
	...
	public Map<String, Object> boardUserOne(BoardDto boardDto) {
		...
		// 게시판 :
		// bt_no,bt_title,bt_content,bt_bt_date,bt_hit,bt_group,bt_indent,bt_replu,
	...
	public Map<String, Object> board_Report_list(NumberDto numberDto) {
		...
		List<BoardTotalDto> list = boardTotalMapper.SelectReportBoardList(nDto.getStartrow(), nDto.getEndrow(),
	...
	public Map<String, Object> board_Man_BoardList(NumberDto numberDto) {
		...
		// 게시글 가져오기
		List<BoardTotalDto> list = boardTotalMapper.SelectManBoardList(nDto.getStartrow(), nDto.getEndrow(),
				nDto.getCategory(), nDto.getSearchword());
	...
	public Map<String, Object> board_My_List(NumberDto numberDto) {
		...
		// 게시글 가져오기
		List<BoardTotalDto> list = boardTotalMapper.SelectMyBoardList(nDto.getStartrow(), nDto.getEndrow(),
				nDto.getCategory(), nDto.getSearchword(), nDto.getU_no());
	...
	public Map<String, Object> board_info(NumberDto numberDto) {
		...
		List<BoardDto> list = boardMapper.selectInfoBoardList(nDto.getStartrow(), nDto.getEndrow(), nDto.getCategory(),
				nDto.getSearchword(), nDto.getBc_no());
		map.put("list", list);
		map.put("nDto", nDto);
		return map;
	}
	...
	// 메인페이지 미니 게시판(공지사항)
	@Override
	public List<BoardDto> mainMiniNoitice() {
		List<BoardDto> list = boardMapper.mainMiniNotice();
		
		return list;
	}
	// 메인페이지 미니 게시판(정보게시판)
	@Override
	public List<BoardDto> mainMiniInfo() {
		List<BoardDto> list = boardMapper.mainMiniInfo();
		return list;
	}
	// 메인페이지 미니 게시판(거래게시판)
	@Override
	public List<BoardDto> mainMiniTrade() {
		List<BoardDto> list = boardMapper.mainMiniTrade();
		return list;
	}
	// 메인페이지 미니 게시판(자유게시판)
	@Override
	public List<BoardDto> mainMiniFree() {
		List<BoardDto> list = boardMapper.mainMiniFree();
		return list;
	}
	// 메인페이지 미니 게시판(유저게시판)
	@Override
	public List<BoardDto> mainMiniUser() {
		List<BoardDto> list = boardMapper.mainMiniUser();
		return list;
	}
	// 메인페이지 미니 게시판(농장주게시판)
	@Override
	public List<BoardDto> mainMiniFarmer() {
		List<BoardDto> list = boardMapper.mainMiniFarmer();
		return list;
	}
