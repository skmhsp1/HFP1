...
public class MemberServiceImpl implements MemberService {
	...
	public FarmDto my_farm_reser_now(int u_no) {
		Integer fr_no = memberMapper.findMyFarm(u_no);
		FarmDto fDto = farmMapper.selectReserInfo(fr_no);
		String result="";	
		result = farmMapper.OneAccount(fr_no);
	...
	// 유저회원 회원가입하기
		...
		public Map<String, Object> myExpBookList(int u_no) {
			...
			// 마이페이지 : (농장주)가 보는 유저의 신청내역 체험 예약 건수 보기
