...
public class ManagerServiceImpl implements ManagerService {
	...
	// 메인페이지 월별 파종 추천 작물
	@Override
	public ManagerDto mainRecomment() {
		ManagerDto mDto = managerMapper.mainRecomment();
		return mDto;
	}
	@Override
	public List<ManagerDto> mainCrops() {
		List<ManagerDto> list = managerMapper.mainCrops();
		return list;
	}
