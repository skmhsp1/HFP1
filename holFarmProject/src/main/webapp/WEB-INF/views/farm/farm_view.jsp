...
<head>
    ...
    function modalNow(){
    	...
    	}else if(${session_frno==param.fr_no}){
    		alert("회원님이 등록한 농장은 예약이 불가능합니다.");
    	}else{
                ...
                <div class="shop-detail-tab-area" style="margin-bottom: 50px;">
                    ...
                    <div id="content-left">
                        ...
                        <div>
			                ...
			                <c:if test="${fn:contains(testStr,'수도')}">
			                	<img src="../images/water.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'휴식공간')}">
			                	<img src="../images/restplace.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'화장실')}">
			                	<img src="../images/toilet.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'삽')}">
			                	<img src="../images/shovel.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'삼지창')}">
			                	<img src="../images/trident.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'호미')}">
			                	<img src="../images/hoe.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'호스')}">
			                	<img src="../images/hose.png" class="serviceIcon">
			                </c:if>
			                <c:if test="${fn:contains(testStr,'거름판매')}">
			                	<img src="../images/manure.png" class="serviceIcon">
			                </c:if>
                        </div>
                    </div>
            ...
            <!-- 리뷰 -->
                <div class="shop-detail-tab-content small" style="width: 1200px;">
                    <div class="review-area" style="width: 100%;">
                        ...
                        <c:if test="${map2.list[0].fr_no!=param.fr_no}">
                        <div>
                            <textarea name="frv_content" id="frv_content" cols="30" rows="10" readonly>농장 예약 후 리뷰를 작성해보세요!</textarea>
                        </div>
                        </c:if>
                        <c:if test="${map2.list[0].fr_no==param.fr_no}">
                        <div>
